...
public interface XPathListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link XPathParser#wcpsHotWords}.
	 * @param ctx the parse tree
	 */
	void enterWcpsHotWords(XPathParser.WcpsHotWordsContext ctx);
	/**
	 * Exit a parse tree produced by {@link XPathParser#wcpsHotWords}.
	 * @param ctx the parse tree
	 */
	void exitWcpsHotWords(XPathParser.WcpsHotWordsContext ctx);
}